...
FM_GUARD_GRACE=300      # seconds before guard warnings, arm health checks, the primary turn-end guard, and the launchd watchdog checker treat a watcher beacon as stale
