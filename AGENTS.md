...
state/               runtime records and signals; gitignored
  ...
  .claude-autoarm.lock .claude-autoarm-epoch .claude-autoarm-failure-notified .claude-autoarm-failure-alarmed .turnend-claude-blocks .turnend-claude-blocks.lock   Claude Stop auto-arm single-flight (the lock is shared with the opt-in launchd watchdog checker; docs/watcher-watchdog.md), epoch, failure-episode, attended-alarm, guard-budget, and budget-lock records; never touch
